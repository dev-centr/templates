...
This is the Base repository. It holds instructions and support files for setting up your local machine.
...
3. Open the `FoodTruckNerdz.code-workspace` file in VSCode.

> [!Warning]
> If your repositories are set up incorrectly, files will not show under their respective root nodes. The root nodes will not contain files.
