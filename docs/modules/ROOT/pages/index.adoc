...
These templates are designed to be installed via the https://github.com/devcntr-app/dev-center[**Dev Center**] application. The Dev Center provides a native GUI to:
...
* **Sync & Apply**: Apply `.code-workspace` settings and extension recommendations to existing repositories.
