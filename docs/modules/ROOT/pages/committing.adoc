...
For a full in-depth explanation of config levels, see this article: https://www.theserverside.com/blog/Coffee-Talk-Java-News-Stories-and-Opinions/Where-system-global-and-local-Windows-Git-config-files-are-saved[System, global, and local Git config files on Windows and Linux+GNU+GNU]
