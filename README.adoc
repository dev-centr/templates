...
For detailed guides on how to use these templates and configure your development environment, see the link:https://devcntr-app.github.io/docs[Standard Project Templates Documentation].
