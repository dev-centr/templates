...
For detailed guides on how to use these templates and configure your development environment, see the link:https://docs.devcntr.org[Standard Project Templates Documentation].
